...
final class Version20220219225142 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TRIGGER reset_module_sequence AFTER TRUNCATE ON module FOR STATEMENT EXECUTE FUNCTION reset_sequence();');
        ...
        $this->addSql('CREATE TRIGGER reset_permission_sequence AFTER TRUNCATE ON permission FOR STATEMENT EXECUTE FUNCTION reset_sequence();');
        ...
        $this->addSql('CREATE TRIGGER reset_user_sequence AFTER TRUNCATE ON "user" FOR STATEMENT EXECUTE FUNCTION reset_sequence();');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TRIGGER reset_user_sequence ON "user";');
        $this->addSql('DROP TRIGGER reset_permission_sequence ON permission;');
        $this->addSql('DROP TRIGGER reset_module_sequence ON module;');
